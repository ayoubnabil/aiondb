  ...
  var palette = [
    {
      ...
      shaderDeep: [5, 5, 6],
      shaderMoss: [76, 78, 84],
      shaderSage: [154, 157, 164],
      shaderMilk: [236, 238, 242]
    },
    {
      bg: [3, 3, 4],
      bg2: [12, 12, 14],
      ...
      shaderDeep: [6, 6, 7],
      shaderMoss: [82, 84, 90],
      shaderSage: [166, 168, 176],
      shaderMilk: [242, 243, 246]
    },
    {
      bg: [6, 6, 8],
      bg2: [14, 14, 17],
      ...
      accent3: [250, 250, 252],
      shaderDeep: [8, 8, 10],
      shaderMoss: [92, 94, 102],
      shaderSage: [180, 182, 188],
      shaderMilk: [247, 248, 250]
    },
    {
      bg: [2, 2, 3],
      bg2: [9, 9, 11],
      ...
      shaderDeep: [4, 4, 5],
      shaderMoss: [70, 72, 78],
      shaderSage: [144, 146, 154],
      shaderMilk: [232, 234, 238]
    }
  ];
