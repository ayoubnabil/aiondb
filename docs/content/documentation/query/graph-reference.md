...
`shortestPath` and `allShortestPaths` support multi-segment typed patterns, including combinations of fixed segments with at most one bounded variable-length segment.
