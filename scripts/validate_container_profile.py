...
def main() -> int:
    ...
    for label in (
        ...
        'org.opencontainers.image.source="https://github.com/ayoubnabil/aiondb"',
        'org.opencontainers.image.documentation="https://github.com/ayoubnabil/aiondb/tree/main/packaging"',
        'org.opencontainers.image.url="https://aiondb.xyz/"',
    ):
