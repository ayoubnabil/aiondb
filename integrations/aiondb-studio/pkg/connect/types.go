...
var (
	...
	errBackendRequestTooLarge  = errors.New("backend credential request exceeds maximum size")
	errBackendResponseTooLarge = errors.New("backend credential response exceeds maximum size")
