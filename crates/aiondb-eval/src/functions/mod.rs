    ...
    fn is_implemented(info: &FunctionInfo) -> bool {
        match &info.func {
            ...
            | "pg_get_triggerdef"
                        ...
                        | "graph_relationships"
                        | "l2_distance"
                        | "pg_catalog.l2_distance"
                        | "cosine_distance"
                        | "pg_catalog.cosine_distance"
                        | "inner_product"
                        | "pg_catalog.inner_product"
                        | "negative_inner_product"
                        | "pg_catalog.negative_inner_product"
                        | "manhattan_distance"
                        | "pg_catalog.manhattan_distance"
                        | "l1_distance"
                        | "pg_catalog.l1_distance"
                        | "hamming_distance"
                        | "pg_catalog.hamming_distance"
                        | "jaccard_distance"
                        | "pg_catalog.jaccard_distance"
                        | "vector_in"
                        | "pg_catalog.vector_in"
                        | "vector_out"
                        | "pg_catalog.vector_out"
                        | "halfvec_in"
                        | "pg_catalog.halfvec_in"
                        | "halfvec_out"
                        | "pg_catalog.halfvec_out"
                        | "sparsevec_in"
                        | "pg_catalog.sparsevec_in"
                        | "sparsevec_out"
                        | "pg_catalog.sparsevec_out"
                        | "array_to_vector"
                        ...
                        | "sparsevec_to_vector"
                        | "pg_catalog.sparsevec_to_vector"
                        | "sparsevec_to_halfvec"
                        | "pg_catalog.sparsevec_to_halfvec"
                        | "array_to_sparsevec"
