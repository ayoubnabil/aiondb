...
const PGVECTOR_OPERATOR_SPECS: &[PgvectorOperatorSpec] = &[
    ...
    PgvectorOperatorSpec {
        type_oid: COMPAT_PGVECTOR_VECTOR_OID,
        name: "+",
        proc_name: "vector_add",
        result_oid: COMPAT_PGVECTOR_VECTOR_OID,
    },
    PgvectorOperatorSpec {
        type_oid: COMPAT_PGVECTOR_VECTOR_OID,
        name: "-",
        proc_name: "vector_sub",
        result_oid: COMPAT_PGVECTOR_VECTOR_OID,
    },
    PgvectorOperatorSpec {
        type_oid: COMPAT_PGVECTOR_VECTOR_OID,
        name: "*",
        proc_name: "vector_mul",
        result_oid: COMPAT_PGVECTOR_VECTOR_OID,
    },
    PgvectorOperatorSpec {
        type_oid: COMPAT_PGVECTOR_VECTOR_OID,
        name: "||",
        proc_name: "vector_concat",
        result_oid: COMPAT_PGVECTOR_VECTOR_OID,
    },
    PgvectorOperatorSpec {
    ...
    PgvectorOperatorSpec {
        type_oid: COMPAT_PGVECTOR_HALFVEC_OID,
        name: "+",
        proc_name: "halfvec_add",
        result_oid: COMPAT_PGVECTOR_HALFVEC_OID,
    },
    PgvectorOperatorSpec {
        type_oid: COMPAT_PGVECTOR_HALFVEC_OID,
        name: "-",
        proc_name: "halfvec_sub",
        result_oid: COMPAT_PGVECTOR_HALFVEC_OID,
    },
    PgvectorOperatorSpec {
        type_oid: COMPAT_PGVECTOR_HALFVEC_OID,
        name: "*",
        proc_name: "halfvec_mul",
        result_oid: COMPAT_PGVECTOR_HALFVEC_OID,
    },
    PgvectorOperatorSpec {
        type_oid: COMPAT_PGVECTOR_HALFVEC_OID,
        name: "||",
        proc_name: "halfvec_concat",
        result_oid: COMPAT_PGVECTOR_HALFVEC_OID,
    },
    PgvectorOperatorSpec {
