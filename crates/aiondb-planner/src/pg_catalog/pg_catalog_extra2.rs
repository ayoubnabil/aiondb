...
const PGVECTOR_CASTS: &[PgvectorCastSpec] = &[
    ...
    PgvectorCastSpec {
        source: COMPAT_PGVECTOR_HALFVEC_OID,
        target: COMPAT_PGVECTOR_SPARSEVEC_OID,
        func_name: "halfvec_to_sparsevec",
        func_argtypes: "80003 23 16",
        context: "i",
        method: "f",
    },
    PgvectorCastSpec {
        source: COMPAT_PGVECTOR_SPARSEVEC_OID,
        target: COMPAT_PGVECTOR_VECTOR_OID,
        func_name: "sparsevec_to_vector",
        func_argtypes: "80005 23 16",
        context: "a",
        method: "f",
    },
    PgvectorCastSpec {
        source: COMPAT_PGVECTOR_SPARSEVEC_OID,
        target: COMPAT_PGVECTOR_HALFVEC_OID,
        func_name: "sparsevec_to_halfvec",
        func_argtypes: "80005 23 16",
        context: "a",
        method: "f",
    },
