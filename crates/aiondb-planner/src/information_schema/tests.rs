...
fn output_fields_for_columns() {
    ...
    assert_eq!(fields[20].name, "character_set_catalog");
    assert_eq!(fields[21].name, "numeric_precision");
    assert_eq!(fields[22].name, "numeric_precision_radix");
    assert_eq!(fields[23].name, "numeric_scale");
    assert_eq!(fields[24].name, "datetime_precision");
    assert_eq!(fields[27].name, "udt_catalog");
    assert_eq!(fields[28].name, "udt_schema");
    assert_eq!(fields[29].name, "udt_name");
    assert_eq!(fields[30].name, "dtd_identifier");
}
