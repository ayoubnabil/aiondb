...
impl Executor {
    fn compat_row_security_setting_enabled(&self, context: &ExecutionContext) -> DbResult<bool> {
    ...
    fn compat_query_affected_by_rls_error(&self, table: &TableDescriptor) -> DbError {
    ...
    fn parse_compat_rls_expression(
        &self,
        expression_sql: &str,
        context: &str,
    ...
    fn type_check_compat_rls_expression(
        &self,
    ...
    pub(super) fn dml_extract_in_list_with_residual(
        &self,
        filter: &TypedExpr,
    ...
    pub(super) fn dml_extract_pushdown_bounds(
        &self,
        filter: &TypedExpr,
        table: &TableDescriptor,
    ) -> Option<(
    ...
    pub(super) fn dml_extract_eq_conjuncts_with_residual(
        &self,
        filter: &TypedExpr,
    ...
    pub(super) fn dml_filter_proves_empty(
        &self,
        filter: &TypedExpr,
        table: &TableDescriptor,
    ...
    pub(super) fn compile_compat_rls_policies(
        &self,
        table: &TableDescriptor,
    ...
    #[inline]
    pub(super) fn compat_rls_allows_existing_row(
        &self,
    ...
    pub(super) fn compat_rls_enforce_new_row(
        &self,
        table: &TableDescriptor,
        policies: Option<&[CompatRlsPolicy]>,
        row: &Row,
    ...
    fn prefetch_sequence_next_values(
        &self,
        sequence_name: &str,
        row_count: usize,
        context: &ExecutionContext,
    ...
    fn same_next_value_sequence_for_column(
        rows: &[Vec<TypedExpr>],
        column_idx: usize,
    ) -> Option<&str> {
    ...
    fn prefetch_insert_values_next_values(
        &self,
        rows: &[Vec<TypedExpr>],
        column_count: usize,
        context: &ExecutionContext,
