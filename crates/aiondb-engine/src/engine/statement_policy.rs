...
//!
//! No implementation here -- all logic lives in `aiondb-pg-compat` (see
//! ADR-0004 on retiring the compat layer from the engine side). Existing
//! callers keep importing via `super::statement_policy::*`; only the
//! source moved.
