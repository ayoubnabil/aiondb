...
#[test]
#[ignore = "pathological allocation case; run with AIONDB_RUN_DOS_CASE=1 --ignored"]
...
#[test]
#[ignore = "pathological input; run with AIONDB_RUN_DOS_CASE=1 --ignored"]
...
#[test]
#[ignore = "OOM regression case; AIONDB_RUN_OOM_CASE=1"]
